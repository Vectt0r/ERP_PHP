        ...
        <input type="hidden" name="id" value="<?= $info['id']; ?>">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" placeholder="nome" value="<?= $info['nome']; ?>">
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control col-md-8" id="idade" name="idade" placeholder="idade" value="<?= $info['idade']; ?>">
                </div>
                <div class="form-group">
                    <label for="inputAddress2">CPF</label>
                    <input type="text" class="form-control col-md-8 cpf" id="cpf" name="cpf" placeholder="xxx.xxx.xxx-xx" value="<?= $info['cpf']; ?>">
                </div>
                <div class="form-row">
