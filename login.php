...
.register-button {
      ...
      /* Estilo para o título do formulário de cadastro */
      .form-title {
          font-size: 24px;
          margin-top: 20px;
          margin-bottom: 10px;
...
<body>
    ...
    <form action="processar_login.php" method="POST" class="form-container">
        <h3>Login</h3>
        ...
        <a href="cadastro.php"><button type="button" class="register-button">Cadastre-se</button></a>    
    </form>
</body>
</html>
